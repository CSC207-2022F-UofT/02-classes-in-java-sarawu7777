...
public class Silly implements Comparable<Silly>{
     ...
     * This constructor takes in two strings, and set name to be str1 + str2
     * @param str1
     * @param str2
     */
    ...
    public int compareTo(Silly other) {
        ...
        int cur_silly_len = this.name.length();
        int other_silly_len = other.name.length();

        if (cur_silly_len > other_silly_len){
            return 1;
        }else if (cur_silly_len == other_silly_len){
            return 0;
        }else{
            return -1;
        }
